            ...
            <Slider ref={refSlider} {...settings}>
                <div className={clsx(styles.itemSlider)}>
                    ...
                    <div className={`${clsx(styles.itemSliderTitle)}`}>
                        <p className={`${clsx(styles.storeName)} storeName`}>
                            ELESSI STORE
                        </p>
                        <p className={`${clsx(styles.storeDesc)} storeDesc`}>
                            EXCLUSIVE <br /> T-SHIRT DESIGNS
                        </p>
                        <NavLink
                            to="/"
                            className={`${styles.linkToShop} linkShop`}
                        >
                            SHOP NOW
                        </NavLink>
                    </div>
                ...
                <div className={clsx(styles.itemSlider)}>
                    ...
                    <div className={`${clsx(styles.itemSliderTitle)}`}>
                        ...
                        <p className={`${clsx(styles.storeDesc)} storeDesc`}>
                            30% Off with <span>promo code</span>
                        </p>
                        <NavLink
                            to="/"
                            className={`${styles.linkToShop} linkShop`}
